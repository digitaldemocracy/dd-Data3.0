-- table filled by legislator_migrate.py, Cal-Access-Accessor.py
...
-- table filled by legislator_migrate.py
...
-- tables filled by Get_Committees_Web.py
...
-- tables filled by Bill_Extract.py
...
-- tables filled by Cal-Access-Accessor.py
