...
def insert_committee_name(cursor, name, house):
    ...
    try:
        ...
        logger.exception(format_logger_message('Insert Failed for Committee',(QI_COMMITTEE_NAMES%(name, house, STATE))))
...
def insert_committee(cursor, house, name, commType, room, phone, fax, year):
    ...
    try:
        ...
        logger.exception(format_logger_message('Insert Failed for Committee',(QI_COMMITTEE%(cid, house, name, commType, STATE, room, phone, fax, year, shortName))))
...
def insert_serveson(cursor, pid, year, house, cid, position, serve_count):
    ...
    try:
        ...
        logger.exception(format_logger_message('Insert Failed for servesOn',(QI_SERVESON%(pid, termYear, house, cid, position, STATE, today))))
...
def get_committee_id(cursor, house, name, commType, comm_count, room, phone, fax, year):
    ...
    try:
        ...
        logger.exception(format_logger_message('Select Failed for Committee',(QS_COMMITTEE%(house, name, commType, STATE))))
...
def get_person_id(cursor, name, house, year, pfinder):
    ...
    #except MySQLdb.Error:
    #  logger.exception(format_logger_message('Select Failed', full_msg=traceback.format_exc(),
...
def clean_servesOn(cursor, cid, house, year):
    ...
    try:
        ...
        logger.exception(format_logger_message('Delete Failed for servesOn',(QD_SERVESON%(cid, house, year, STATE))))
...
def update_committee_room(cursor, cid, room):
    ...
    try:
        ...
        logger.exception(format_logger_message('Update Failed for Committee',(QU_COMMITTEE_ROOM%(room, cid))))
...
def update_committee_phone(cursor, cid, phone):
    ...
    try:
        ...
        logger.exception(format_logger_message('Update Failed for Committee',(QU_COMMITTEE_PHONE%(phone, cid))))
...
def update_committee_fax(cursor, cid, fax):
    ...
    try:
        ...
        logger.exception(format_logger_message('Update Failed for Committee',(QU_COMMITTEE_FAX%(fax, cid))))
        ...
        for row in cursor.fetchall():
            ...
            if pid not in current_pid:
                try:
                    ...
                    logger.exception(format_logger_message('Update Failed for servesOn',(QU_SERVESON_ENDDATE%(today, pid))))
