...
"""
File: ny_committee_parser.py
Author: Nathan Philliber
Date: 3/27/2018

Description:
  - This file creates a New York specific parser for parsing OpenStates committee data.
"""

from OpenStatesParsers.committee_openstates_parser import *


class NyCommitteeParser(CommitteeOpenStateParser):
    def __init__(self, session_year, leg_session_year, api):
        ...
        '''
        super(NyCommitteeParser, self).__init__(api, "NY", session_year, leg_session_year, "Senate", "Assembly")
